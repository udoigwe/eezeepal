$(function () {
    ...
    function loadAssignations(course_id = '', user_id = '')
    {
        ...
        table.DataTable({
            ...
            ajax: {
                type: 'GET',
                url: `${API_URL_ROOT}/assignations/data-table/fetch?department_id=${departmentID}&course_id=${course_id}&user_id=${user_id}`,
                dataType: 'json',
                headers:{'x-access-token':token},
                complete: function()
                {
    ...
    function loadAcademicStaff()
    {
        ...
        $.ajax({
            url:`${API_URL_ROOT}/users?user_role=Academic&department_id=${departmentID}`,
            type:'GET',
            dataType:'json',
            headers:{'x-access-token':token},
            success:function(response)
