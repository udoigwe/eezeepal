$(function () {
    ...
    $(document).ready(function($) {
        ...
        $('#form-course-filter').on("submit", function(e){
            ...
            loadCourses(levelID, courseType, courseSemester, courseStatus);
        })
    });
    ...
    function newCourse() 
    {
        swal({
            ...
            if (result.value) 
            {
                ...
                {
                    //remove any appended department ID
                    form.find('.department_id').remove();

                    // Append department ID to the form. 
    ...
    //load Courses
    function loadCourses(level_id = '', course_type = '', course_semester = '', course_status = '')
    {
        var table = $('#courses');
        ...
        table.DataTable({
            ...
            ajax: {
                type: 'GET',
                url: `${API_URL_ROOT}/courses/data-table/fetch?department_id=${departmentID}&level_id=${level_id}&course_type=${course_type}&course_semester=${course_semester}&course_status=${course_status}`,
                dataType: 'json',
                headers:{'x-access-token':token},
                complete: function()
                {
