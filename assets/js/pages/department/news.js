$(function () {
    ...
    $(document).ready(function($) {
        ...
        $('#news').on('click', '.btn-edit', function(){
            ...
            $.ajax({
                url: API_URL_ROOT+'v1/news/single/'+newsID,
                type: 'GET',
                dataType: 'json',
        ...
        swal({
            ...
            if (result.value) 
            {
                ...
                else
                {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: API_URL_ROOT+'v1/contributor/news/new',
        ...
        swal({
            ...
            if (result.value) 
            {
                ...
                if(coveringImage == "" || coveringImage == null)
                {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: API_URL_ROOT+'v1/contributor/news/update',
                        data: form.serialize(),
                        dataType: 'json',
                        headers:{Authorization:'Bearer '+token},
                        success: function(response)
    ...
    function loadNews()
    {
        ...
        table.DataTable({
            ...
            ajax: {
                type: 'GET',
                url: API_URL_ROOT+'v1/contributor/news/data-table',
                dataType: 'json',
                headers:{Authorization:'Bearer '+token},
                complete: function()
                {
