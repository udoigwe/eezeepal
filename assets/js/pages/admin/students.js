            ...
            $.ajax({
                ...
                success: function(response)
                {
                    if(response.error == false)
                    {
                        ...
                        editModal.find('#reg_no1').val(user.reg_no);
                        editModal.find('#department_id1').val(user.department_id);
                        editModal.find('#current_level1').val(user.current_level);
        ...
        $.ajax({
            ...
            success: function(response)
            {
                if(response.error == false)
                {
                    ...
                    $("#current_level").append(html);
                    $("#current_level1").append(html);
                    $('.selectpicker').selectpicker('refresh');
                    unblockUI();
                }
                else
