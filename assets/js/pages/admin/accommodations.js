$(function () {
	...
	$(document).ready(function($){
        ...
        $("#form-accommodations-filter").on("submit", function(event){

            event.preventDefault();
            
            var form = $(this);
            var hostelID = form.find('select.hostel_id').val();
            ...
            loadAccommodations(hostelID, semesterID);
            unblockUI();                 
        });
    });

    //load Accommodations
    function loadAccommodations(hostelID = '', semesterID = '')
    {
        ...
        table.DataTable({
            ...
            ajax: {
                type: 'GET',
                url: `${API_URL_ROOT}/accommodations/data-table/fetch?hostel_id=${hostelID}&semester_id=${semesterID}`,
                dataType: 'json',
                headers:{'x-access-token':token},
                complete: function()
                {
