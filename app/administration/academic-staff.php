...
<html lang="en">
<head>
    <title>Admin | Academic Staff Management</title>
...
<body onload="notLoggedInCheck(); displayUserProfile();">
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                ...
                                <h4 class="page-title">Academic Staff Management</h4>
                            </div>
                        </div>
                    </div>     
                    <!-- end page title -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                <h4 class="header-title">New Academic Staff</h4>
                                <p class="sub-header">
                                ...
                                <form action="#" id="form-new-user" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="courses" class="col-form-label">Assigned Courses <span class="red-asteriks">*</span></label>
                                            <select id="courses" name="courses" class="form-control selectpicker required" data-live-search="true" multiple></select>
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" id="user_role" name="user_role" class="required" value="Academic">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Existing Academic Staff</h4>
                                    <p class="text-muted font-13 mb-4">
                                        Click the edit or delete buttons attached to a user to update OR delete a user record respectively
                                    </p>

                                    <table id="users" class="table activate-select dt-responsive" user-role="Academic">
                                        <thead>
                                            <tr>
                                                <th>SNO</th>
                                                <th>Full Name</th>
                                ...
                                <div class="modal-body p-4">
                                    ...
                                    <form action="#" id="form-update-user" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="courses1" class="col-form-label">Assigned Courses <span class="red-asteriks">*</span></label>
                                                <select id="courses1" name="courses" class="form-control selectpicker required" data-live-search="true" multiple></select>
                                            </div>
                                        </div>
                                        <div class="form-row">
    ...
    <!-- page script -->
    <script src="../../assets/js/pages/admin/academic-staff.js"></script>
