                            ...
                            <div class="card-box">
                                ...
                                <form action="#" id="form-new-user" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="reg_no" class="col-form-label">Registration Number <span class="red-asteriks">*</span></label>
                                        <input type="text" class="form-control required" id="reg_no" name="reg_no" placeholder="Student Registration Number">
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="department_id" class="col-form-label">Department <span class="red-asteriks">*</span></label>
                                            <select id="department_id" name="department_id" class="form-control selectpicker required" data-live-search="true">
                                                <option value="">Choose a department</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="current_level" class="col-form-label">Current Level <span class="red-asteriks">*</span></label>
                                            <select id="current_level" name="current_level" class="form-control selectpicker required">
                                    ...
                                    <input type="hidden" id="user_role" name="user_role" class="required" value="Student">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <table id="users" class="table activate-select dt-responsive" user-role="Student">
                                        <thead>
                                            <tr>
                                                <th>SNO</th>
                                                <th>Full Name</th>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    ...
                                    <form action="#" id="form-update-user" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label for="reg_no1" class="col-form-label">Registration Number <span class="red-asteriks">*</span></label>
                                            <input type="text" class="form-control required" id="reg_no1" name="reg_no" placeholder="Student Registration Number">
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="department_id1" class="col-form-label">Department <span class="red-asteriks">*</span></label>
                                                <select id="department_id1" name="department_id" class="form-control selectpicker required" data-live-search="true">
                                                    <option value="">Choose a department</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="current_level1" class="col-form-label">Current Level <span class="red-asteriks">*</span></label>
                                                <select id="current_level1" name="current_level" class="form-control selectpicker required">
