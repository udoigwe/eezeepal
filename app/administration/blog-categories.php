...
<body onload="notLoggedInCheck(); displayUserProfile();">
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                <h4 class="header-title">New Blog Category</h4>
                                <p class="sub-header">
                                ...
                                <form action="#" id="form-new-category">
                                    ...
                                    <input type="hidden" class="category_type required" value="Blog" name="category_type">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card-box">
                                <h4 class="header-title">Blog Category Filter</h4>
                                <p class="sub-header">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Existing Blog Categories</h4>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-4">
                                    <form action="#" id="form-update-category">
                                        ...
                                        <input type="hidden" name="category_type" class="required category_type" value="Blog">
    ...
    <!-- page script -->
    <script src="../../assets/js/pages/admin/blog-categories.js"></script>
