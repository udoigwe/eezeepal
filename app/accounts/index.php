...
<body onload="notLoggedInCheck(); displayUserProfile();">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row bursar" style="display: none">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card-box widget-icon">
                                <div class="avatar-lg float-left">
                                    <i class="mdi mdi-currency-ngn text-success avatar-title display-4 m-0"></i>
                                </div>
                                <div class="wid-icon-info text-right">
                                    <p class="text-muted mb-1 font-13 text-uppercase">Total Income Today</p>
                                    <h4 class="mb-1 counter total-income-today">0</h4>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card-box widget-icon">
                                <div class="avatar-lg float-left">
                                    <i class="mdi mdi-currency-ngn text-danger avatar-title display-4 m-0"></i>
                                </div>
                                <div class="wid-icon-info text-right">
                                    <p class="text-muted mb-1 font-13 text-uppercase">Total Expenditure Today</p>
                                    <h4 class="mb-1 counter total-expenditure-today">0</h4>
                                    <!-- <small class="text-info"><b>0%</b></small> -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card-box widget-icon">
                                <div class="avatar-lg float-left">
                                    <i class="mdi mdi-currency-ngn text-warning avatar-title display-4 m-0"></i>
                                </div>
                                <div class="wid-icon-info text-right">
                    ...
                    <div class="row">
                        <div class="col-xl-9 col-lg-9 col-md-9 col-12 bursar" style="display: none">
                            <!-- Portlet card -->
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-0">Revenue Generation For <?php echo date('Y'); ?></h4>

                                    <div id="cardCollpase6" class="collapse pt-3 show" dir="ltr">
                                        <div id="revenue-report-chart" class="apex-charts"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->

                        <div class="col-xl-9 col-lg-9 col-md-9 col-12 cashier" style="display: none">
                            <div class="card-box">
                                <h4 class="header-title mb-3">My Recent Entries</h4>

                                <table class="table activate-select dt-responsive" id="recent-entries">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-md-6">
                            <div class="card-box widget-icon">
                                <div class="avatar-lg float-left">
                                    <i class="mdi mdi-toggle-switch text-warning avatar-title display-4 m-0"></i>
                                </div>
                                <div class="wid-icon-info text-right">
                                    <p class="text-muted mb-1 font-13 text-uppercase">Accounting Portal</p>
                                    <h4 class="mb-1 accounting-portal-status">-</h4>
                                    <!-- <small class="text-danger"><b>56% Down</b></small> -->
                                </div>
                            </div>
                        </div>
    ...
    <!-- page script -->
    <script src="../../assets/js/pages/accounts/index.js"></script>
