...
<body onload="notLoggedInCheck(); displayUserProfile();">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">My News Articles</h4>
                                    <p class="text-muted font-13 mb-4">
                                        Click the edit or delete buttons attached to a news article to update OR delete a news article respectively. You can only have access to news articles composed and uploaded by you.
                                    </p>
    ...
    <!-- page script -->
    <script src="../../assets/js/pages/contributor/news.js"></script>
