...
<body onload="notLoggedInCheck(); displayUserProfile();">
					...
					<div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <div class="card-box widget-icon">
                                ...
                                <div class="wid-icon-info text-right">
                                    <p class="text-muted mb-1 font-13 text-uppercase">Assigned Courses</p>
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-9 col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-0">Assigned Students</h4>

                                    <div id="cardCollpase6" class="collapse pt-3 show" dir="ltr">
                                        <div id="assigned-students-chart" class="apex-charts"></div>
                                    </div> <!-- collapsed end -->
                                </div> <!-- end card-body -->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
	...
	<!-- page script -->
    <script src="../../assets/js/pages/academics/index.js"></script>
