...
<html lang="en">
<head>
    <title>Students | My Result Sheet</title>
...
<body onload="notLoggedInCheck(); displayUserProfile();">
                            ...
                            <div class="card-box">
                                ...
                                <form action="#" id="form-select-resultsheet">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label for="access_pin" class="col-form-label">Access Pin <span class="red-asteriks">*</span></label>
                                            <input type="text" name="access_pin" class="form-control required access_pin" placeholder="Enter your 14 character Access Pin" />
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-success">Load My Result Sheet</button>
                                </form>
                            </div>
                        </div>
                    </div>
    ...
    <!-- page script -->
    <script src="../../assets/js/pages/students/results.js"></script>
