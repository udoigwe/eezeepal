                            ...
                            <div class="col-lg-4 col-xl-4">
                                <div class="card-box text-center">
                                    ...
                                    <div class="text-left mt-3">
                                        ...
                                        <p class="text-muted mb-1 font-13"><strong>Section :</strong> <span class="ml-2 my-section"></span></p>

                                        <p class="text-muted mb-1 font-13"><strong>Reg Number :</strong> <span class="ml-2 my-reg-no"></span></p>

                                        <p class="text-muted mb-1 font-13"><strong>Department :</strong> <span class="ml-2 my-department"></span></p>

                                        <p class="text-muted mb-1 font-13"><strong>Current Level :</strong> <span class="ml-2 my-current-level"></span></p>
                                    </div>
                                </div> <!-- end card-box -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required user_firstname" name="user_firstname" placeholder="Enter your first name">
                                                        </div>
                                                    </div>
                                                </div> <!-- end row -->
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required user_lastname" name="user_lastname" placeholder="Enter your last name">
                                                        </div>
                                                    </div>
                                                </div> <!-- end row -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="user_gender" class="form-control required selectpicker user_gender">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control required user_email" name="user_email" placeholder="Enter email">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required user_phone" name="user_phone" placeholder="Enter phone">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required user_contact_address" name="user_contact_address" placeholder="Enter your contact address">
                                                        </div>
                                                    </div>
                                                </div> <!-- end row -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control required user_next_of_kin" name="user_next_of_kin" placeholder="Next Of Kin">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="user_next_of_kin_phone">Next Of Kin Phone Number <span class="red-asteriks">*</span></label>
                                                            <input type="text" class="form-control required user_next_of_kin_phone" name="user_next_of_kin_phone" placeholder="Next Of Kin's Phone number">
                                                        </div>
                                                    </div>
                                                </div> <!-- end row -->
                                        ...
                                        <div class="tab-pane" id="security-settings">
                                            <form id="form-update-password">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="password" class="form-control required current_password" name="current_password" placeholder="Current password">
                                                </div>
                                                <div class="form-group">
                                                    <label for="new_password" class="col-form-label">New Password</label>
                                                    <input type="password" class="form-control required new_password" name="new_password" placeholder="New prefered password">
                                                </div>
                                                <div class="form-group">
                                                    <label for="re_password" class="col-form-label">Confirm Password</label>
                                                    <input type="password" class="form-control required re_password" name="re_password" placeholder="Must match new password">
                                                </div>
